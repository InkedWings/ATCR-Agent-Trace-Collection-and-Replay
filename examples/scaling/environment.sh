...
export PATH="${MSWEA_SQUASHFS_BINDIR:-/soft/spack/pe/0.10.1/base/install/linux-sles15-x86_64_v3/gcc-13.3.1/squashfs-4.6.1-tsvowgrjjsitjf3fa742v4g66ofa4eom/bin}:${PATH}"
